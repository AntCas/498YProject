...
WifiPhy::ChannelToFrequencyWidthMap WifiPhy::m_channelToFrequencyWidth =
{
  ...
  { std::make_pair (1, WIFI_PHY_STANDARD_80211b_HACKED), std::make_pair (2412, 22) },
  ...
  { std::make_pair (2, WIFI_PHY_STANDARD_80211b_HACKED), std::make_pair (2417, 22) },
  ...
  { std::make_pair (3, WIFI_PHY_STANDARD_80211b_HACKED), std::make_pair (2422, 22) },
  ...
  { std::make_pair (4, WIFI_PHY_STANDARD_80211b_HACKED), std::make_pair (2427, 22) },
  ...
  { std::make_pair (5, WIFI_PHY_STANDARD_80211b_HACKED), std::make_pair (2432, 22) },
  ...
  { std::make_pair (6, WIFI_PHY_STANDARD_80211b_HACKED), std::make_pair (2437, 22) },
  ...
  { std::make_pair (7, WIFI_PHY_STANDARD_80211b_HACKED), std::make_pair (2442, 22) },
  ...
  { std::make_pair (8, WIFI_PHY_STANDARD_80211b_HACKED), std::make_pair (2447, 22) },
  ...
  { std::make_pair (9, WIFI_PHY_STANDARD_80211b_HACKED), std::make_pair (2452, 22) },
  ...
  { std::make_pair (10, WIFI_PHY_STANDARD_80211b_HACKED), std::make_pair (2457, 22) },
  ...
  { std::make_pair (11, WIFI_PHY_STANDARD_80211b_HACKED), std::make_pair (2462, 22) },
  ...
  { std::make_pair (12, WIFI_PHY_STANDARD_80211b_HACKED), std::make_pair (2467, 22) },
  ...
  { std::make_pair (13, WIFI_PHY_STANDARD_80211b_HACKED), std::make_pair (2472, 22) },
  ...
  { std::make_pair (14, WIFI_PHY_STANDARD_80211b_HACKED), std::make_pair (2484, 22) },
...
WifiPhy::ConfigureDefaultsForStandard (WifiPhyStandard standard)
{
  ...
  switch (standard)
    ...
    case WIFI_PHY_STANDARD_80211b:
      ...
      break;
    case WIFI_PHY_STANDARD_80211b_HACKED:
      SetChannelWidth (22);
      SetFrequency (2412);
      // Channel number should be aligned by SetFrequency () to 1
      NS_ASSERT (GetChannelNumber () == 1);
...
void
WifiPhy::Configure80211b_HACKED (void)
{
  NS_LOG_FUNCTION (this);
